...
2. Now project the stock forward 100 years using *u* = 0 and the value for *u*~MSY~ you just found. Plot the projected biomass over time and show that the long-term equilibrium biomass values from fishing at *u* = 0 and *u*~MSY~ are *K* and *K*/2 = *B*~MSY~ estimated from Question 1. The code below will help with the projections (stored in array **P**).
