...
The two-parameter Schaefer model produces a symmetrical yield curve. More complex, non-symmetrical versions of this model exist (e.g., the Pella-Tomlinson model; Hilborn and Walters 1992) and, indeed, similar yield curves are produced by age-structured models. The important concept from this exercise is that $F_\text{MSY}$ (or its instantaneous equivalent $F_\text{MSY}$, which we'll see in Exercise 2) is the long-term fishing mortality rate that would maximize yield in the long-term under stable conditions.
